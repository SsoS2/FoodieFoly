...
<!-- 	 -->
		(필수) <br>
		아이디 <input type ="text" name = "us_id" id="us_id" class="id"  maxlength="16"  class="border"> <br>
		<font id="checkId" size="2"></font><br>
		
		비밀번호 <input type = "password" name = "us_pw" maxlength="20" class="pw" id="us_pw1"class="border"> <br>
        비밀번호 확인 <input type = "password" name = "us_pwC" maxlength="20" class="pw" id="us_pw2"class="border"> 
                <font id="checkPw" size="2" ></font><br><br>
                
		이름(실명) <input type = "text" name = "us_name" maxlength="6" class="border"> <br><br>
		닉네임 <input type = "text" name = "us_nick" maxlength="8" class="border"> <br><br>
		이메일 
		<input type ="email" name = "us_email" id="us_email" class="border"> <br>
		<font id="checkEmail" size="2"></font><br>
		전화번호(-제외) <input type = "tel" name = "us_tel" maxlength="11"class="border"> <br>
		
		<br> (선택) <br>
		생년월일 
		<select name="us_birY" class="border">
...
/* 				SimpleDateFormat sdf = new SimpleDateFormat("yyyy");
		...
		<select name="us_birM"  class="border">
		...
		<select name="us_birD"  class="border">
		...
		<br>
		주소 <input type = "text" name = "us_addr" class="border"> <br>
